...
I2C1->OAR1 |= 0x4000;
I2C1->CR1 &= ~I2C_CR1_PE; 	
I2C1->CR2 = 0x0010; 		// 16MHz takt, can go to 42Mhz
I2C1->CCR = 0x50;			// T=1/F=1/100khz=0.01ms,Ton=0.01ms/2=5000ns jer because we want the duty cycle to be 0.5
...
// B(Backlight), pozadinsko osvjetljenje 1 - on 0 - off
